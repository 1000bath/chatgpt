...
export const ACCOUNT_MEMORY_SAVED_MARKER = "CHATGPT_MEMORY_SAVED";
...
export function buildAccountMemoryPrompt(value: string): string {
  ...
  return [
    ...
    "CHATGPT_MEMORY_NOT_SAVED: <brief reason>",
    "",
...
export const ACCOUNT_MEMORY_LIST_BEGIN = "CHATGPT_MEMORY_LIST_BEGIN";
export const ACCOUNT_MEMORY_LIST_END = "CHATGPT_MEMORY_LIST_END";
export const ACCOUNT_MEMORY_FORGOTTEN_MARKER = "CHATGPT_MEMORY_FORGOTTEN";
 ...
 */
export const ACCOUNT_MEMORY_EMPTY_MARKER = "CHATGPT_MEMORY_NONE";
...
export function buildAccountMemoryForgetPrompt(value: string): string {
  ...
  return [
    ...
    "CHATGPT_MEMORY_NOT_FORGOTTEN: <brief reason>"
  ].join("\n");
}
