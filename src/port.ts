/**
 * The contract this package implements, kept free of any host-application
 * types so the backend can be dropped into a gateway, an agent loop, or a
 * standalone script without dragging a framework along.
 */
